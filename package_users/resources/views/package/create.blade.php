...
@endif
      ...
      <div class="items_wrapper">
      <img class="item_img" style="border-radius: 50%; border: 3px solid #642d64;" src="{{ asset('img/hoodie.jpeg') }}" width="8%" height="8%" alt="">
      ...
      <div class="items_wrapper">
      <img class="item_img" style="border-radius: 50%; border: 3px solid #642d64;" src="{{ asset('img/nametag.jpeg') }}" width="8%" height="8%" alt="">
      ...
      <div class="items_wrapper">
      <img class="item_img" style="border-radius: 50%; border: 3px solid #642d64;" src="{{ asset('img/bracelet.jpeg') }}" width="8%" height="8%" alt="">
      ...
      <div class="items_wrapper">
      <img class="item_img" style="border-radius: 50%; border: 3px solid #642d64;" src="{{ asset('img/pin.jpeg') }}" width="8%" height="8%" alt="">
